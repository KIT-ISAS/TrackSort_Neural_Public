#!/bin/sh
cd ..
## Train separation prediction on DEM cuboids data
...
./main.py \
  ...
  --dataset_dir 'data/DEM_Data/csv_converted_FOV/Cuboids_115_200Hz.csv' \
  ...
  --no_show True \
  --logfile logs/terminal_logs/run_train_separation_DEM_cuboids.log
...
./main.py \
  ...
  --config_path configs/DEM_cuboids/train_cuboids_sep_gating_me.json \
  --dataset_dir 'data/DEM_Data/csv_converted_FOV/Cuboids_115_200Hz.csv' \
  --dataset_type CsvDataset \
  --data_is_aligned False \
  --rotate_columns True \
