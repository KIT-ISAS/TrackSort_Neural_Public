...
class TrackManager(object):
    ...
    def real_track_real_measurement(global_track_id, measurement):
    	self.tracks.add_measurement(measurement, is_artificial=False)
    	self.model_manager.update_by_id(global_track_id, measurement)

    def real_track_pseudo_measurement(global_track_id, measurement):
    ...
    def pseudo_track_real_measurement(measurement, current_timestep):
